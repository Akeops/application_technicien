<?php
	...
	echo(" (<a href='inc/accounts.inc.php?logout' target='_self'>Deconnexion</a>)</pre>");
	
	$users = array(
		'arnaud'	=> 'Arnaud PRIGENT',
		'esteban'	=> 'Esteban BORSATO',
		'dylan'		=> 'Dylan PELLETIER',
		'romain'	=> 'Romain JOLY',
		'leo'		=> 'Léo SZAFARZ',
		'anne'		=> 'Anne HUCHER',
		'thierry'	=> 'Thierry BORSATO',
...
<html>
	...
	<body>
		...
		<img id="logo" src="images/logo.png" alt="logo tacteo">
		...
		<form id="form" action="https://docs.google.com/forms/d/e/1FAIpQLScZSmU4vlVtPDONliKSud6PG41AvvGqiq7u_KCVrKLWiahxIg/formResponse" target="response" method="POST">
		...
		<fieldset id="AGENCE">		<!-- 01 -->
			...
			<input type="<?php echo($hide); ?>" name="entry.433474814" value="FLOIRAC" required>
		</fieldset>
		...
		<fieldset id="OBJECT">		<!-- 02 -->
			...
			<table style="font-size: 1.2em;margin:0 auto;">
				<tr>
					<td>
						<label class="switch">
							<input type="checkbox" name="entry.912488796" value="INSTALLATION" required>
				...
				<tr>
					<td>
						<label class="switch">
							<input type="checkbox" name="entry.912488796" value="FORMATION" required>
							<span class="sliderG"></span>
						</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label class="switch">
							<input type="checkbox" name="entry.912488796" value="MAINTENANCE" required>
							<span class="sliderG"></span>
						</label>
					</td>
					<td>
				...
				<tr>
					<td>
						<label class="switch">
							<input type="checkbox" name="entry.912488796" value="RENOUVELLEMENT" required>
							<span class="sliderG"></span>
						</label>
					</td>
					<td>
		...
		<fieldset id="MAT">			<!-- 10 -->
			...
			<textarea style="width:	49%; float:	right; border-radius:	0; margin:	0;" placeholder="Numéro(s) de Série" rows="5" name="entry.2082384825" onchange=""></textarea>
			<textarea style="width:	49%; border-radius:	0; text-align:	right; margin:	0;" placeholder="Nom du/des Matériel(s)" rows="5" name="entry.2047563043" onchange=""></textarea>
		...
		<fieldset id="MAJ">			<!-- 14 -->
			...
			<input id="maj" type="<?php echo($hide); ?>" name="entry.509496568" value="Réalisée" onchange="">
			...
			<div style="display:none" id="factu">
				...
				<table style="width:100%" id="factu">
					...
					<tr>
						...
						<td>
							<select name="entry.1018844855" class="remise" style="font-size:50%" onchange="facturation()">
								<option value="">
								</option>
								<option value="10">
									10.00%
		...
		<fieldset id="TECH">		<!-- 20 -->
			...
			<?php
				...
				// else
				// {
					// echo('<select name="entry.1981179687" id="techs_list" style="display: block; margin: 0 auto; height:	4em; width:	50%; background: rgb(109, 109, 109);" onchange="techsSign()" required>
							// <option value="Jordane MEILLAC">Jordane MEILLAC</option>
							// <option value="Arnaud PRIGENT">Arnaud PRIGENT</option>
							// <option value="Esteban BORSATO">Esteban BORSATO</option>
							// <option value="Dylan PELLETIER">Dylan PELLETIER</option>
							// <option value="Romain JOLY">Romain JOLY</option>
							// <option value="Léo SZAFARZ">Léo SZAFARZ</option>
							// <option value="Anne HUCHER">Anne HUCHER</option>
							// <option value="Thierry BORSATO">Thierry BORSATO</option>
							// <option value="Bruno RODRIGUEZ">Bruno RODRIGUEZ</option>
						// </select>');
				// }
			?>
